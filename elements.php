	...
	<body>
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.php" class="logo"><strong>Methodist</strong> <span>Web Application</span></a>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
					...
					<div id="main" class="alt">
						...
						<!-- One -->
							<section id="one" class="major">
								<div class="inner">
									<!-- Content -->
										<h2 id="content">Sample <?php $key=get_user_uid($con, $_SESSION['UserData']['user_id']); 
                                                            foreach($key as &$name){
                                                                echo $name;                                                                
                                                            }
                                                    ?></h2>
